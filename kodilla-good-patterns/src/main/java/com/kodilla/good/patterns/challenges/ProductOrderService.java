public class RentalProcessor {
    ...
    private InformationService informationService; //powiadomienia
    private RentalService rentalService; //wypozyczalnia
    private RentalRepository rentalRepository;  //db service
